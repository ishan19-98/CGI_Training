...
public class DemoTest {
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		do {
			...
			File file = new File("C:\\\\Users\\\\Administrator\\\\Documents\\\\Assignment_workspace\\\\employee.txt");
			if(file.exists())
			{
			(new ProductService()).deSerializeObject();
			}
			switch (choice) {
		...
		(new ProductService()).serializeObject(); // serializing list of employees before terminating program
